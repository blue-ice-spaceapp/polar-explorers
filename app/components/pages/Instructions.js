...
The story: Taking part in a team of enthusiastic young explorers on a polar quest to save Antarctica from global warming. Troughout your expedition, you encounter many challenges linked to different arreas of scientific research, different time frames  and other common problematics. Your team also learns a lot about equipment, climate, animals and natural phenomenoms.</p>
        </InstructionItem>
        <InstructionItem>
            <T2>Inventory:</T2>
            <p>
            ...
            <ol>
                ...
                <li>
                    ...
                    <ol>
                        ...
                        <li>Read the challange, throw 2 dice if the challange has a required score, else follow the challange requirements</li>
